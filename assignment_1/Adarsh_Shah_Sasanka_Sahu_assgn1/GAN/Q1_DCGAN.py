...
'''
Loss plots can be obtained from tensorboard
'''
...
if __name__ == '__main__':
    ...
    for ep in range(8):
        with tqdm(train_dataloader) as tepoch:
            ...
            for X, _ in tepoch:
                ...
                global_step += 1
                i += 1
                # Code to plot 10 x 10 randomly generated images
                if i % 500 == 0:
    ...
    plt.title("FID Score Plot DC-GAN")

    plt.plot(list1)
    plt.xlabel("Iterations % 500")
    plt.ylabel("FIDs")
    plt.savefig('/home/adarsh/ADRL/assignment_1/GAN/bitmoji_fid/dcgan_fid.png')'''
    ...
    save_image(Z_img*0.5+0.5,
            f'/home/adarsh/ADRL/assignment_1/GAN/dc_gan/dc_gan_latent_traversal.png')
